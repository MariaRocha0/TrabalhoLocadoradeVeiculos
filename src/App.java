...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        ListaCliente lc = new ListaCliente(ll);
        ListaVeiculo lv = new ListaVeiculo(ll);
        ListaCategoria lca = new ListaCategoria(lv);
        ...
        try {
            ...
            for(int i = 1; i < contentBreak.length; i++) {
                ...
                try {
                    ...
                    System.out.println("Erro ao passar ano para int: " + e.getMessage());
              }
                ...
                try {
                    ...
                    System.out.println("Erro ao passar categoria para Inteiro: " + e.getMessage());
                }
